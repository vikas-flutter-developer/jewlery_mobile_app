...
const storePath = path.resolve(__dirname, "fallbackStore.json");
...
export const mockAmlLogs: any[] = createPersistentArrayProxy("mockAmlLogs", [
  ...
  },
  {
    ...
    customerPhone: "9654321087",
    amount: 320000,
    paymentMethod: "Cash",
    panNumber: "NOT PROVIDED",
    flaggedReason: "Cash purchase above ₹2L without PAN — Form 60 required",
    createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString()
  },
  {
    logId: "AML-2026-003",
    ...
    amount: 450000,
    paymentMethod: "Mixed (Cash + UPI)",
    panNumber: "NOT PROVIDED",
    flaggedReason: "Split payment structure suspected to avoid PAN reporting limit",
    createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString()
  },
  {
    logId: "AML-2026-004",
    ...
    amount: 215000,
    paymentMethod: "Cash",
    panNumber: "PQRST9876X",
    flaggedReason: "High-value bridal gold necklace cash transaction flagged for PMLA audit",
    createdAt: new Date(Date.now() - 4 * 24 * 60 * 60 * 1000).toISOString()
  },
  {
    logId: "AML-2026-005",
    ...
    flaggedReason: "Repeated large purchases within 30-day window — cross-transaction AML review",
    createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString()
  }
]);
