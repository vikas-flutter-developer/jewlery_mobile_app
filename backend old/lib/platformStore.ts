...
const isBackendCwd = fs.existsSync(path.resolve(currentDir, ".env.local")) || fs.existsSync(path.resolve(currentDir, ".env")) || fs.existsSync(path.resolve(currentDir, "package.json"));
